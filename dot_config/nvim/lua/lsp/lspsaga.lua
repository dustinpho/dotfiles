...
function M.on_attach(client, bufnr)
  ...
  vim.keymap.set("n", "K", "<cmd>Lspsaga hover_doc<CR>", { buffer = bufnr, desc = "LSP Hover Doc" })
  ...
  vim.keymap.set("n", "<leader>o", "<cmd>Lspsaga outline<CR>",
    { buffer = bufnr, desc = "Show document symbols in an outline sidebar." })
  vim.keymap.set("n", "gr", "<cmd>Lspsaga finder<CR>", { buffer = bufnr, desc = "LSP Finder (refs and defs)" })
